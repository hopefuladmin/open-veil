    ...
    private function get_trial_questionnaire_data(int $trial_id): array {
        $questionnaire = [
            ...
            'experiment_setup' => [
                ...
                'experiment_time' => get_post_meta($trial_id, 'experiment_time', true),
            ...
            'substances_used' => [
                'main_substance' => get_post_meta($trial_id, 'main_substance', true),
                'route_of_administration' => get_post_meta($trial_id, 'route_of_administration', true),
