...
* Protocol Post Type
* 
* Registers the Protocol custom post type
*/
class Protocol {
   /**
    * Constructor
   ...
   /**
    * Register the Protocol post type
    */
   ...
   /**
    * Register meta fields for the Protocol post type
    */
   ...
   /**
    * Add custom columns to the Protocol post type admin list
    */
   ...
   /**
    * Render custom column content for the Protocol post type admin list
    */
